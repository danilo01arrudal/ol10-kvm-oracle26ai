...
-- 2 . REGIONS table holds region information for locations
...
-- 3 . COUNTRIES table holds country information for customers and company locations.
...
-- 4 . LOCATIONS table holds address information for company departments.
...
--5 . Useful for any subsequent addition of rows to LOCATIONS table
...
-- 6 . DEPARTMENTS table holds company department information.
...
-- 7 . Useful for any subsequent addition of rows to DEPARTMENTS table
...
-- 8 . JOBS table holds the different names of job roles within the company.
...
-- 9 . EMPLOYEES table holds the employee personnel information for the company.
...
-- 11 . Useful for any subsequent addition of rows to employees table.
...
-- 12 . JOB_HISTORY table holds the history of jobs that employees have held in the past.
...
-- 14 . insert data into the REGIONS table
...
-- 15 . insert data into the COUNTRIES table
...
-- 16 . insert data into the LOCATIONS table
...
-- 18 . insert data into the DEPARTMENTS table
...
-- 19 . insert data into the JOBS table
...
-- 20 . insert data into the EMPLOYEES table 1
...
-- 21 . insert data into the EMPLOYEES table 2
...
-- 22 . insert data into the EMPLOYEES table 3
...
-- 23 . insert data into the EMPLOYEES table 4
...
-- 24 . insert data into the EMPLOYEES table 5
...
-- 25 . insert data into the EMPLOYEES table 6
...
-- 26 . insert data into the JOB_HISTORY table
...
-- 33 . Beginning of comments on tables and columns
